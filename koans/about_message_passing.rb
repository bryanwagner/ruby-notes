...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # send is likely to be overridden because it's a terrible method name to select for a base class;
    # these are horrible design choices for a language.
    # Also I suppose because you need obj.__send__(:send) but just...no
  end
